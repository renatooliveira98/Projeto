...
<!--  class="form-control"  -->
	...
	<div class="row">
		...
		<label for="cidade">Cidade</label> 
			<input class="form-control" type="text" name="cidade" id="cidade" value="${estudante.usuario.endereco.cidade}">
		</div>
	</div>
	...
	<div class="row">
		...
		<label for="bairro">Bairro</label> 
			<input class="form-control" type="text" name="bairro" id="bairro" value="${estudante.usuario.endereco.bairro}">
		</div>
		<div class="form-group col-lg-4">
			<label for="rua">rua</label> 
			<input class="form-control" type="text" name="rua" id="rua" value="${estudante.usuario.endereco.rua}">
		</div>
		<div class="form-group col-lg-4">
			<label for="numero">numero</label> 
			<input class="form-control" type="text" name="numero" id="numero" value="${estudante.usuario.endereco.numero}">
		</div>
	</div>
